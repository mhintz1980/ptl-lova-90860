...
describe('Department Staffing Logic', () => {
    ...
    it('should initialize with default values', () => {
        ...
        const testing = capacityConfig.testing;

        expect(fab.employeeCount).toBe(4);
        expect(fab.efficiency).toBe(0.85);
        expect(fab.dailyManHours).toBeCloseTo(4 * 8 * 0.85);

        expect(testing.employeeCount).toBe(0.25);
        expect(testing.dailyManHours).toBeCloseTo(0.25 * 8 * 0.85);
    });
    ...
    it('should update dailyManHours when employeeCount changes (decimal)', () => {
        ...
        expect(fab.dailyManHours).toBeCloseTo(2.5 * 8 * 0.85); // 17
    });
    ...
    it('should update dailyManHours when employeeCount changes', () => {
        ...
        expect(fab.dailyManHours).toBeCloseTo(10 * 8 * 0.85); // 68
    });
