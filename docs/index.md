---
title: "PumpTracker Lite – Development Guide"
doc_type: "development_guide"
app_name: "PumpTracker Lite"
version: "1.0"
status: "active"
audience: ["contributors", "agent_coders"]
related_docs:
  - "Architecture Overview"
  - "Testing Guide"
  - "PumpTracker Lite – Deployment Guide"
summary: >
  Day-to-day workflow for humans and agents: environment setup, coding conventions,
  state management rules, and how to safely extend core features like Kanban and Scheduling.
---
